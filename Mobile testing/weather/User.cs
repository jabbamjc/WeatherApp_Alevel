...
namespace weather
{
    class User : UserAccountsSql //inherits from UserAccountsSql to get it's functionality
    {
        ...
        public static ArrayList GetPlanters()
        {
            return Garden.Planters; //returns the planters in the garden 
        }
