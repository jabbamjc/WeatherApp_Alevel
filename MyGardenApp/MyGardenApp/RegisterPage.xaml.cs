...
public partial class RegisterPage : ContentPage
{
	...
	{
		bool valid = UserAccountSql.EmailInUse(email); //uses the sqldatabase functionality to check if given email is in the database
	...
	{
		bool valid = UserAccountSql.UsernameInUse(username); //uses the sqldatabase functionality to check if given username is in the database
